  ...
  try {
    ...
    switch (name) {
      case "instruct_agents":
        return await handleInstructAgents(args as unknown as Parameters<typeof instructAgents>[0]);

      case "get_agent_status":
        return await handleGetAgentStatus(args as unknown as Parameters<typeof getAgentStatus>[0]);

      case "create_todo":
        return await handleCreateTodo(args as unknown as Parameters<typeof createTodo>[0]);

      case "update_todo":
        return await handleUpdateTodo(args as unknown as Parameters<typeof updateTodo>[0]);

      case "get_todos":
        return await handleGetTodos(args as unknown as Parameters<typeof getTodos>[0]);

      case "complete_todo":
        return await handleCompleteTodo(args as unknown as Parameters<typeof completeTodo>[0]);

      // タスク管理ツール
      case "create_task":
        return await handleCreateTask(args as unknown as Parameters<typeof createTask>[0]);

      case "update_task":
        return await handleUpdateTask(args as unknown as Parameters<typeof updateTask>[0]);

      case "get_tasks":
        return await handleGetTasks(args as unknown as Parameters<typeof getTasks>[0]);

      case "complete_task":
        return await handleCompleteTask(args as unknown as Parameters<typeof completeTask>[0]);

      case "delete_task":
        return await handleDeleteTask(args as unknown as Parameters<typeof deleteTask>[0]);

      case "check_task_dependencies":
        return await handleCheckTaskDependencies(args as { id?: number; task_id?: string });
...
async function handleInstructAgents(args: Parameters<typeof instructAgents>[0]) {
  try {
...
async function handleGetAgentStatus(args: Parameters<typeof getAgentStatus>[0]) {
  try {
...
// TODO管理: create_todo
async function handleCreateTodo(args: Parameters<typeof createTodo>[0]) {
  try {
...
// TODO管理: update_todo
async function handleUpdateTodo(args: Parameters<typeof updateTodo>[0]) {
  try {
...
// TODO管理: get_todos
async function handleGetTodos(args: Parameters<typeof getTodos>[0]) {
  try {
...
async function handleCompleteTodo(args: Parameters<typeof completeTodo>[0]) {
  try {
...
// タスク管理: create_task
async function handleCreateTask(args: Parameters<typeof createTask>[0]) {
  try {
...
// タスク管理: update_task
async function handleUpdateTask(args: Parameters<typeof updateTask>[0]) {
  try {
...
// タスク管理: get_tasks
async function handleGetTasks(args: Parameters<typeof getTasks>[0]) {
  try {
...
// タスク管理: complete_task
async function handleCompleteTask(args: Parameters<typeof completeTask>[0]) {
  try {
...
// タスク管理: delete_task
async function handleDeleteTask(args: Parameters<typeof deleteTask>[0]) {
  try {
...
async function handleCheckTaskDependencies(args: { id?: number; task_id?: string }) {
  try {
